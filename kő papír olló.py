...
elif ok1 == "kő" and ok2 == "papír":
    print("az első játékos nyert")
elif ok2 == "kő" and ok1 == "papír":
    print("a második játékos nyert")
elif ok1 == "kő" and ok2 == "olló":
    print("a második játékos nyert")
elif ok1 == "olló" and ok2 == "kő":
    print("az első játékos nyert")
elif ok1 == "papír" and ok2 == "olló":
    print("a második játékos nyert")
elif ok1 == "olló" and ok2 == "papír":
    print("az első játékos nyert")
else:
